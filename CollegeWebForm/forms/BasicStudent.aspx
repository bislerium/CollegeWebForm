...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h2>CRUD Student</h2>
    <p>
        Create, read, update and delete studennt using the labelled fields and buttons.
    </p>
                ...
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="MODULE_ID" DataSourceID="SqlDataSource1" GridLines="Horizontal" Width="750px">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Actions" ShowHeader="False">
                            ...
                            <ItemTemplate>
                                <asp:Button class="btn btn-success" ID="Button3" runat="server" CausesValidation="False" CommandName="Edit" Text="Edit" />
                                &nbsp;<asp:Button class="btn btn-danger" ID="Button4" runat="server" CausesValidation="False" CommandName="Delete" Text="Delete" />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
